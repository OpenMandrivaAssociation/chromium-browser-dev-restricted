...
# All sorts of not very python3 friendly build scripts in the tree...
...
# All sorts of not very python3 friendly build tools in the tree... Let's make
# sure they see python2 when calling python
